...
import 'package:test_app1/components/bottom_up_transition.dart';
import 'package:test_app1/dto/datas.dart';
import 'package:test_app1/endpoints/endpoints.dart';
import 'package:test_app1/screens/routes/formScreen/form_screen.dart';
import 'package:test_app1/services/data_service.dart';
...
class _DatasScreenState extends State<DatasScreen> {
  ...
  void initState() {
    super.initState();
    _datas = DataService.fetchDatas() as Future<List<Datas>>?;
  }
